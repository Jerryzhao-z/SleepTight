...
public class EndDatePickerDialogFragment extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    ...
    public EndDatePickerDialogFragment(BaseCalendarEvent newEvent) { this.newEvent = newEvent; }
    ...
    public interface onDateSetFinishedListener {
        public void onDateSetFinished(int date);
